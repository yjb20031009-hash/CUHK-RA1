function [ ggvalue , gvalue , betamat ] = my_estimation_prepostdid1_high(myparam)
...
otcost = myparam(2)*500000/(y60+y61);
...
% 全面混合did
load Sample_did_nosample_high.mat %我们只需要beta和W
...
%{
W(17,17)=W(17,17)*20;
W(18,18)=W(18,18)*1000;

W(26,26)=W(26,26)*50;
W(27,27)=W(27,27)*2000;

W(33,33)=W(33,33)*5;
W(34,34)=W(34,34)*1500;
%}
%{
W(13,13)=W(13,13)*20;
W(14,14)=W(14,14)*100;
